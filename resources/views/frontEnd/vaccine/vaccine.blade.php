                        ...
                        <div class="all-contact-text">
                            <div class="row">
                                <div class="col-lg-6 bm-t">
                                    <h4 class="book-an-appointment-h">Vaccine</h4>
                                </div>
                                                                                                     ...
                                                                                                     <div class="md-cart">
                                                                                                         ...
                                                                                                         <div class="card">
                                                                                                             <div class="card-body medi-cart">
                                                                                                                 <div class="card-img">
                                                                                                                 <img src="{{($item->image)? asset('admin/product/upload/'.$item->image): url('admin/product/upload/hospital.jpg') }}" class="height" >                                                                                                                 </div>
                                                                                                                 <div class="card-text">
                                                                                                                     <h4>{{$item->name}}</h4>
                                                                                                  ...
                                                                                                  <div class="col-md-4">
                                                                                                     <div class="md-cart">
                                                                                                         ...
                                                                                                         <div class="card">
                                                                                                             <div class="card-body medi-cart">
                                                                                                                 <div class="card-img">
                                                                                                                 <img src="{{($item->image)? asset('admin/product/upload/'.$item->image): url('admin/product/upload/hospital.jpg') }}" class="height" >
                                                                                                                 </div>
                                                                                                                 <div class="card-text">
                                                                                                                     <h4>{{$item->name}}</h4>
                                                                                                                     <p>{{$item->product_type}}</p>
