                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
                                    ...
                                    {{ Form::model($product,['route'=>'otherproduct.update','method'=>'post','enctype'=>'multipart/form-data']) }}

                                    <!--  PRODUCT NAME  -->
                                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>

                                            <label>Use Old Name <input type="checkbox" name="oldname" value="1" > </label>
                                        </div>
                                    ...
                                    <!-- / PRODUCT NAME  -->
                                    <!--  PRODUCT LOCAL NAME  -->
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 {{$errors->has('price') ? 'has-error' : ''}}">
                                        <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        ...
                                        {{ Form::label('old',"Old Image : ",['class'=>'control-label']) }}
                                        <img src="{{ asset('public/admin/product/upload/'.$product->image) }}" alt="image" style="height: 70px;width: 70px;" id="image">

                                    </div>

                                    <div class="col-lg-8 col-sm-8  col-md-8 col-xs-12 {{$errors->has('description') ? 'has-error' : ''}}">
                                        <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        ||
                                        <a href="{{ route('otherproduct.add') }}" class="btn btn-danger">Cancel Edit</a>
                                    </div>
                                    {{ Form::close() }}
                                </div>
                            </div>
