...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Individual Product Sale / Purchase Report</h1>
                </div>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="demo-pli-home"></i></a></li>
                    <li><a href="#">Admin</a></li>
                    <li class="active">Individual Product Sale / Purchase Report</li>
                </ol>
            </div>
            <div id="page-content">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Individual Product Sale / Purchase Report</h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <!--  PRODUCT NAME  -->
                                        <div class="col-lg-2 col-sm-4 col-xs-12 {{$errors->has('product_name') ? 'has-error' : ''}}">
                                            ...
                                            {{ Form::select('product_name',['0'=>'Warehouse 1'],null,['class'=>'form-control ','placeholder'=>'Select Warehouse','required','id'=>'product_name'])}}
                                        </div>
                                        <div class="col-lg-2 col-sm-4 col-xs-12 {{$errors->has('product_name') ? 'has-error' : ''}}">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                            {{ Form::label('product','Vaccine/Product Name  : ',['class'=>'control-label'])}}
                                            {{ Form::select('product_name',['0'=>'Hapatitis A'],null,['class'=>'form-control ','placeholder'=>'Select Product','required','id'=>'product_name'])}}
                                        </div>
                                        <div class="col-lg-2 col-sm-4 col-xs-12">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                            {{ Form::label('product','Product Type : ',['class'=>'control-label'])}}
                                            {{ Form::select('product_name',['0'=>'Vaccine','1'=>'Health Product'],null,['class'=>'form-control ','placeholder'=>'Select Product','required','id'=>'product_name'])}}
                                        </div>
                                        <div class="col-lg-2 col-sm-4 col-xs-12 ">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                            {{ Form::label('product','Sale / Purchase Report : ',['class'=>'control-label'])}}
                                            {{ Form::select('product_name',['0'=>'Sale','1'=>'Purchase'],null,['class'=>'form-control ','placeholder'=>'Select Product','required','id'=>'product_name'])}}
                                        </div>
                                        <div class="col-lg-4 col-sm-4 col-md-6 col-xs-12" style="float: right;">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
