...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Individual Product Report</h1>
                </div>
                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Individual Product Report</h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <!--  PRODUCT NAME  -->
                                        <div class="col-lg-3 col-sm-4 col-xs-12 {{$errors->has('product_name') ? 'has-error' : ''}}">
                                            ...
                                            {{ Form::select('product_name',['0'=>'Warehouse 1'],null,['class'=>'form-control ','placeholder'=>'Please Select Warehouse','required','id'=>'product_name'])}}
                                        </div>
                                        <div class="col-lg-3 col-sm-4 col-xs-12 {{$errors->has('product_name') ? 'has-error' : ''}}">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                            {{ Form::label('product','Vaccine/Product Name  : ',['class'=>'control-label'])}}
                                            {{ Form::select('product_name',['0'=>'Hapatitis A'],null,['class'=>'form-control ','placeholder'=>'Please Select Product','required','id'=>'product_name'])}}
                                        </div>
