...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Update Blood Bank</h1>
                </div>
                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Update Blood Bank</h3>
                            </div>
                            <div class="panel-body">
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                    {{ Form::model($bloodbank,['route'=>'bank.update','method'=>'post','enctype'=>'multipart/form-data']) }}
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 {{$errors->has('police_station_id') ? 'has-error' : ''}}">
                                        ...
                                        {{ Form::select('police_station_id',$policeStations,null,['class'=>'form-control']) }}
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 {{$errors->has('blood_group') ? 'has-error' : ''}}">
                                        {{ Form::label('blood_group','Select Blood Group',['class'=>'label-control']) }}
                                        {{ Form::select('blood_group',trans('bloodgroup'),null,['class'=>'form-control']) }}
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 {{$errors->has('rh_fector') ? 'has-error' : ''}}">
                                        {{ Form::label('rh_fector','Select Rh Fector',['class'=>'label-control']) }}
                                        {{ Form::select('rh_fector',trans('rh_fector'),null,['class'=>'form-control']) }}
                                    ...
                                    <div class="col-md-4 col-xs-12">
                                        {{ Form::button('UPDATE BLOOD BANK',['type'=>'submit','id'=>'saveCategory','class'=>'btn-block btn btn-primary']) }}
                                    </div>
                                    {{ Form::close() }}
                                </div>
