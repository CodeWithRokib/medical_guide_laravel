...
@section('content')
    ...
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Edit Role</h1>
                </div>
                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                {{ Form::model($role,['action'=>['backend\RoleController@update',$role->id],'method'=>'patch']) }}
                                {{Form::label('name','Role Name: ',['class'=>'control-label'])}}
                                {{Form::text('name',null,['class'=>'form-control'])}}
                                </div>
                                {{--<div class="col-lg-12 col-sm-12 {{$errors->has('name') ? 'has-error' : ''}}">--}}
                                    {{--{{Form::label('name','Permissions: ',['class'=>'control-label'])}}--}}
                                    {{--{{ Form::select('permissions[]',$permissions,null,['class'=>'form-control','multiple'=>'mulitiple','id'=>'permission_id']) }}--}}
                                {{--</div>--}}
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 {{$errors->has('permission') ? 'has-error' : ''}}">
                                            ...
                                            @foreach($user as $user_permission)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $user_permission->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" @php if($check == 'checked'){echo $check;}else{}  @endphp  class="user-select" name="asignpermission[]" value="{{$user_permission->id}}" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @foreach($role_permission as $role)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $role->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" @php if($check == 'checked'){echo $check;}else{}  @endphp  class="role-select" name="asignpermission[]" value="{{$role->id}}" />
                                        ...
                                        <div class="col-md-4">
                                            @foreach($company as $company_permission)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $company_permission->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="company-select" name="asignpermission[]" value="{{$company_permission->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                        ...
                                        <div class="col-md-4">
                                            @foreach($supplier as $supplier_permission)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $supplier_permission->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="supplier-select" name="asignpermission[]" value="{{$supplier_permission->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                        ...
                                        <div class="col-md-4">
                                            @foreach($customers as $customer_permission)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $customer_permission->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="customer-select" name="asignpermission[]" value="{{$customer_permission->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                        ...
                                        <div class="col-md-4">
                                            @foreach($product as $vaccine)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $vaccine->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="vaccine-select" name="asignpermission[]" value="{{$vaccine->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                            ...
                                            @foreach($other_product as $other)
                                                    @php
                                                        foreach($currentpermissions as $currentpermission){
                                                            if($currentpermission->permission_key == $other->permission_key){$check = 'checked';break;}else{$check = '';};
                                                        }
                                                    @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="vaccine-select" name="asignpermission[]" value="{{$other->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                        ...
                                        <div class="col-md-4">
                                            @foreach($purchase_vaccine as $p_vaccine)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $p_vaccine->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="purchase-select" name="asignpermission[]" value="{{$p_vaccine->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                            ...
                                            @foreach($purchase_other as $p_other)
                                                    @php
                                                        foreach($currentpermissions as $currentpermission){
                                                            if($currentpermission->permission_key == $p_other->permission_key){$check = 'checked';break;}else{$check = '';};
                                                        }
                                                    @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="purchase-select" name="asignpermission[]" value="{{$p_other->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($stock as $product_stock)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $product_stock->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="stock-select" name="asignpermission[]" value="{{$product_stock->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp>
                                        ...
                                        <div class="col-md-4">
                                            @foreach($sale as $product_sale)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $product_sale->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="sale-select" name="asignpermission[]" value="{{$product_sale->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($transfer as $product_transfer)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $product_transfer->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="transfer-select" name="asignpermission[]" value="{{$product_transfer->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($invoice as $product_invoice)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $product_invoice->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="invoice-select" name="asignpermission[]" value="{{$product_invoice->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($expenses as $expense)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $expense->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="expense-select" name="asignpermission[]" value="{{$expense->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($reports as $report)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $report->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="report-select" name="asignpermission[]" value="{{$report->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($hospitals as $hospital)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $hospital->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="hospital-select" name="asignpermission[]" value="{{$hospital->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($doctors as $doctor)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $doctor->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="doctor-select" name="asignpermission[]" value="{{$doctor->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                            ...
                                            @foreach($specialists as $specialist)
                                                    @php
                                                        foreach($currentpermissions as $currentpermission){
                                                            if($currentpermission->permission_key == $specialist->permission_key){$check = 'checked';break;}else{$check = '';};
                                                        }
                                                    @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="doctor-select" name="asignpermission[]" value="{{$specialist->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($divisions as $division)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $division->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="division-select" name="asignpermission[]" value="{{$division->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($blood_banks as $blood_bank)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $blood_bank->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="blood-bank-select" name="asignpermission[]" value="{{$blood_bank->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($ambulances as $ambulance)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $ambulance->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="ambulance-select" name="asignpermission[]" value="{{$ambulance->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                        ...
                                        <div class="col-md-4">
                                            @foreach($wishlists as $wishlist)
                                                @php
                                                    foreach($currentpermissions as $currentpermission){
                                                        if($currentpermission->permission_key == $wishlist->permission_key){$check = 'checked';break;}else{$check = '';};
                                                    }
                                                @endphp
                                                <div class="checkbox">
                                                    <input  type="checkbox" class="wishlist-select" name="asignpermission[]" value="{{$wishlist->id}}" @php if($check == 'checked'){echo $check;}else{}  @endphp >
                                ...
                                <div class="col-md-6 col-xs-12">
                                    {{ Form::button('UPDATE ROLE',['type'=>'submit','id'=>'savebrand','class'=>'btn btn-primary btn-block','style'=>'margin-top:20px']) }}
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <a href="{{route('role.create')}}" class="btn btn-danger btn-block" style="margin-top: 20px"> Cancel</a>
                                </div>
                                {{Form::close()}}
