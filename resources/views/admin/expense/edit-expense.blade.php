...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Edit Expenses</h1>
                </div>
                <ol class="breadcrumb">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
                                    <div class="col-lg-12 col-sm-12 {{$errors->has('name') ? 'has-error' : ''}}">
                                        {{ Form::model($expenses,['route'=>'expense.update','method'=>'post','enctype'=>'multipart/form-data','id'=>'brandForm']) }}
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        ||
                                        <a href="{{ route('expense.add') }}" class="btn btn-danger"> Cancel Edit</a>
                                    </div>
                                    {{ Form::close() }}
                                </div>
