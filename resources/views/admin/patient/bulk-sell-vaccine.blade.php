...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Bulk Sale Vaccine</h1>
                </div>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="demo-pli-home"></i></a></li>
                    <li><a href="#">Admin</a></li>
                    <li class="active">Bulk Sale Vaccine</li>
                </ol>
            </div>
            <div id="page-content">
                <div class="row">
        ...
        z-index: 999;left:-14%">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Bulk Sale Vaccine</h3>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pull-right">
                                    ...
                                    <div class="row">
                                        {{ Form::open(['route'=>'sell.bulk.vaccine.store','method'=>'post','enctype'=>'multipart/form-data']) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <table class="table-hover table table-bordered table-responsive">
                                                ...
                                                <tr>
                                                    <td> <span class="btn btn-primary"> Sale Date : </span></td>
