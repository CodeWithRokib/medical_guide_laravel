...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Update Virtual Lab Info</h1>
                </div>
                <ol class="breadcrumb">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    {{ Form::model($virtuallabs,['route'=>['virtuallab.update',$virtuallabs->id],'method'=>'post','enctype'=>'multipart/form-data']) }}
                                    <!--  PRODUCT NAME  -->
