...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Add / View Virtual Lab</h1>
                </div>
                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add New Virtual Lab</h3>
                            </div>
                                <div class="">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                                                {!! Form::open(['route' => 'virtuallab.store', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                                                ...
                                                <div
                                                    class="col-lg-12 col-sm-12 col-md-12 col-xs-12 {{ $errors->has('type') ? 'has-error' : '' }}">
                                                    <span
                                                        style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                                    {!! Form::button('SAVE VIRTUAL LAB INFO', ['type' => 'submit', 'id' => 'savekarat', 'class' => 'btn btn-primary']) !!}
                                                </div>
                                                {!! Form::close() !!}
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($virtuallabs as $data)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('virtuallab.edit', $data->id) }}"
                                                                        class="btn btn-primary fa fa-edit"></a> ||
                                                                    <button type="button" data-id="{{ $data->id }}"
                                                                        data-url="{{ URL('VirtuallabManagement/erase') }}"
