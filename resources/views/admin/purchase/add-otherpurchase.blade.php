...
@section('content')
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Add New Health-Pruduct Purchase</h1>
                </div>
                <ol class="breadcrumb">
        ...
        z-index: 999;left:-14%">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Add New Health-Pruduct Purchase</h3>
                        </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 {{$errors->has('warehouse_id') ? 'has-error' : ''}}">
                                            ...
                                            {{ Form::select('warehouse_id',$warehouse,null,['class'=>'form-control select2','placeholder'=>'Select Warehouse','required','id'=>'warehouse_id'])}}
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 {{$errors->has('product_name') ? 'has-error' : ''}}">
                                            ...
                                            {{ Form::select('product_name',$product,null,['class'=>'form-control select2','placeholder'=>'Select product','required','id'=>'product_name'])}}
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 {{$errors->has('mrpprice') ? 'has-error' : ''}}">
                                            <span style="display: block;height: 10px;width: 100%;background: #fff;"></span>
                                            {{ Form::label('mrp','MRP Price  :* ',['class'=>'control-label'])}}
                                            {{ Form::text('mrp',null,['class'=>'form-control ','id'=>'mrp','placeholder'=>'Tk : 100 tk'])}}
                                        </div>
